...
import com.dacartec.service.IPlanService;
 ...
 *
 */
public class PlanLogica implements IPlanService {

	private static final Log log = LogFactory.getLog(PlanLogica.class);
